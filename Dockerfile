...
ENV GOBIN /go/bin
WORKDIR /go/src/github.com/cloud-ace/YasunoriKawasaki/cloudbuild-test
COPY / .
...
COPY --from=builder /go/src/github.com/cloud-ace/YasunoriKawasaki/cloudbuild-test/sample-server .
